    ...
    Area Riservata
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/30 backdrop-blur">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl border border-orange-400/20 bg-orange-500/10 p-5 text-orange-100">
              Chi cerca scorciatoie si perde. Chi costruisce un metodo, prima o poi passa all’incasso.
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-center text-sm text-white/45">
        © Sergio Apicella — Tutti i diritti riservati
      </footer>
    </main>
  );
}
